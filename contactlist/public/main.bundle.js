...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_contacts_contacts_component__ = __webpack_require__("../../../../../src/app/components/contacts/contacts.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__components_navbar_navbar_component__ = __webpack_require__("../../../../../src/app/components/navbar/navbar.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__components_home_home_component__ = __webpack_require__("../../../../../src/app/components/home/home.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__components_members_members_component__ = __webpack_require__("../../../../../src/app/components/members/members.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__services_validate_service_validate_service__ = __webpack_require__("../../../../../src/app/services/validate-service/validate.service.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__services_authService_auth_service__ = __webpack_require__("../../../../../src/app/services/authService/auth.service.ts");
...
var routes = [
    ...
    { path: 'members', component: __WEBPACK_IMPORTED_MODULE_9__components_members_members_component__["a" /* MembersComponent */] },
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_6__components_contacts_contacts_component__["a" /* ContactsComponent */],
            __WEBPACK_IMPORTED_MODULE_7__components_navbar_navbar_component__["a" /* NavbarComponent */],
            __WEBPACK_IMPORTED_MODULE_8__components_home_home_component__["a" /* HomeComponent */],
            __WEBPACK_IMPORTED_MODULE_9__components_members_members_component__["a" /* MembersComponent */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_14__services_validate_service_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_16__services_authService_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_17__guards_auth_guard__["a" /* AuthGuard */]],
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_contactService_contact_service__ = __webpack_require__("../../../../../src/app/services/contactService/contact.service.ts");
...
ContactsComponent = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_1__services_contactService_contact_service__["a" /* ContactService */]]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_contactService_contact_service__["a" /* ContactService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_contactService_contact_service__["a" /* ContactService */]) === "function" && _a || Object])
], ContactsComponent);
...
module.exports = "<div class=\"jumbotron text-center\">\n    <h1>Dobble The Social Network For Everyone</h1>\n    <p class=\"lead\">Welcome to our awesome Social Network </p>\n    <div>\n        <a class=\"btn btn-primary\" [routerLink]=\"['register']\">Register</a>\n        <a class=\"btn btn-success\" [routerLink]=\"['login']\">Login</a>\n    </div>\n</div>\n\n<div class=\"row text-center\">\n    <div class=\"col-md-4 col-lg-4\">\n        <h3 class=\"text-primary\">Express Backend</h3>\n        <p>A rock solid Node.js/Express server using Mongoose to organize models and query the database</p>\n    </div>\n    <div class=\"col-md-4 col-lg-4\">\n        <h3 class=\"text-primary\">Angular-CLI</h3>\n        <p>Angular-CLI to generate components, services and more. Local dev server and easy compilation</p>\n    </div>\n    <div class=\"col-md-4 col-lg-4\">\n        <h3 class=\"text-primary\">JWT Tokens</h3>\n        <p>Full featured authentication using JSON web tokens, Login and store user data</p>\n    </div>\n</div>"
    ...
    LoginComponent.prototype.onLoginSubmit = function () {
        ...
        this.authService.authenticateUser(user).subscribe(function (data) {
            ...
            if (data.success) {
                ...
                _this.flashMessage.show('Great ! you are now logged in', { cssClass: 'alert-success text-center',
                    timeout: 3000 });
                _this.router.navigate(['/dashboard']);
            }
            else {
                _this.flashMessage.show(data.msg, { cssClass: 'alert-warning text-center',
                    timeout: 3000 });
...
LoginComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_authService_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_authService_auth_service__["a" /* AuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_router__["b" /* Router */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === "function" && _c || Object])
], LoginComponent);
...
module.exports = "<div class=\"container\">\n    <h2 class=\"page-header text-uppercase\">Register</h2>\n    <form (submit)=\"onRegisterSubmit()\">\n        <div class=\"form-group\">\n            <label>First Name</label>\n            <input required=\"true\" type=\"text\" [(ngModel)]=\"first_name\" name=\"first_name\" class=\"form-control\">\n        </div>\n        <div class=\"form-group\">\n            <label>Last Name</label>\n            <input required type=\"text\" [(ngModel)]=\"last_name\" name=\"last_name\" class=\"form-control\">\n        </div>\n        <div class=\"form-group\">\n            <label>Email</label>\n            <input required type=\"text\" [(ngModel)]=\"email\" name=\"email\" class=\"form-control\">\n        </div>\n        <h2 class=\"page-header\"></h2>\n        <div class=\"form-group\">\n            <label>Username</label>\n            <input required type=\"text\" [(ngModel)]=\"username\" name=\"username\" class=\"form-control\">\n        </div>\n        <div class=\"form-group\">\n            <label>Password</label>\n            <input required type=\"text\" [(ngModel)]=\"password\" name=\"password\" class=\"form-control\">\n        </div>\n        <input type=\"submit\" class=\"btn btn-primary\" value=\"Register\">\n        <h2 class=\"page-header\"></h2>\n    </form>\n</div>"
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_validate_service_validate_service__ = __webpack_require__("../../../../../src/app/services/validate-service/validate.service.ts");
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegisterSubmit = function () {
        ...
        this.authService.registerUser(user).subscribe(function (data) {
            if (data.success) {
                _this.flashMessage.show('you made it ! you are now registered with Dobble Social Network', { cssClass: 'alert-success text-center', timeout: 3000 });
                _this.router.navigate(['/login']);
            }
            else {
                _this.flashMessage.show('Ooops .. something went wrong', { cssClass: 'alert-warning text-center', timeout: 3000 });
...
RegisterComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__services_validate_service_validate_service__["a" /* ValidateService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_validate_service_validate_service__["a" /* ValidateService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_angular2_flash_messages__["FlashMessagesService"]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__services_authService_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_authService_auth_service__["a" /* AuthService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _d || Object])
], RegisterComponent);
...
AuthGuard = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_authService_auth_service__["a" /* AuthService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_authService_auth_service__["a" /* AuthService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _b || Object])
], AuthGuard);
...
/***/ "../../../../../src/app/services/validate-service/validate.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {
